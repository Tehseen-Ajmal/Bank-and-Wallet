...
public class Requests extends javax.swing.JPanel {
    ...
    static Approvals_Request global_ap = new Approvals_Request();
    public Requests(Approvals_Request ac) {
        appr=ac;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText(appr.ac_num_to);
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        global_ap.remove(this.appr);
        global_ap.add_to_file();
        User_Background.showForm(new Send_appr(new UserAcount(User_Background.auth_enter),User_Background.auth_enter));
    }
