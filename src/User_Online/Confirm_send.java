...
public class Confirm_send extends JPanel {
    ...
    String ac_nom = "";
    Float cash;
    public Confirm_send(String ac,Float ca) {
        ac_nom =ac;
        cash =ca;
        initComponents();
    ...
    private void buttonMenu2ActionPerformed(ActionEvent evt) throws IOException {
        ...
        boolean a = Send_mone.gou.send(User_Background.auth_enter,ac_nom, cash,"Ibft");//PK-9140-1822-1341-347
        if (!a){
        JOptionPane.showMessageDialog(this, "Low Balance/Account Doesn't exist...", "Error", JOptionPane.ERROR_MESSAGE);}
        User_Background.showForm(new UserAcount(User_Background.auth_enter));
